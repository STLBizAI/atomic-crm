...
create table public.deals (
    ...
    sales_id bigint,
    index smallint,
    constraint deals_stage_matches_category check (
...
create table public.industries (
   ...
   constraint industries_segment_valid check (
        segment in (
...
alter table public.companies
    add constraint companies_industry_id_fkey foreign key (industry_id) references public.industries(id) on update cascade on delete set null;
