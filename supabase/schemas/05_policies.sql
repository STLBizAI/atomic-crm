...
-- Industries
create policy "Enable read access for authenticated users" on public.industries for select to authenticated using (true);
create policy "Enable insert for authenticated users only" on public.industries for insert to authenticated with check (true);
create policy "Enable update for authenticated users only" on public.industries for update to authenticated using (true);
create policy "Enable delete for authenticated users only" on public.industries for delete to authenticated using (true);
